...
export default function PDF_reader({ file, onExtract }) {
  ...
  return (
    <div onClick={myClick}>
      <div className="hover:border-theme-purple/50 hover:bg-muted/50 flex flex-col items-center justify-center rounded-xl border-2 border-dashed p-4 pb-6 transition-colors hover:cursor-pointer sm:p-6 sm:pb-8 md:p-8 md:pb-10">
